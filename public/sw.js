const CACHE='clue-morning-v2.8.0';
const ASSETS=['./','index.html','styles.css','styles-base.css','app.js','daily-expansion.css','daily-expansion.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png'];
