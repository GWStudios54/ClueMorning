const CACHE='clue-morning-v2.9.0';
const ASSETS=['./','index.html','styles.css','styles-base.css','app.js','daily-expansion.css','daily-expansion.js','daily-presentation-fix.css','daily-presentation-fix.js','last-call.css','last-call.js','presentation-v1.css','presentation-v1.js','founders-ui.css','founders-ui.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png'];
