(()=>{
  const STORE='clue-morning-last-call-v1',EXP_STORE='clue-morning-daily-expansion-v1',LADDER=[0,100,250,500,850,1300,2000];
  ...
  function render(){
    if(!puzzle||!day)return;const pot=currentPot(),done=!!day.done;mirrorLegacyExpansion();
