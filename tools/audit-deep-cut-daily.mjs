...
console.log(`Daily Deep Cut: ${eligible.length}/${DEEP_CUT_PROMPTS.length} prompts pass the quality gate; every post-cutover day has ${DEEP_CUT_MIN_ACCESSIBLE_PER_DAY}+ accessible prompts, no more than ${DEEP_CUT_MAX_DEEP_PER_DAY} deep prompt, ${DEEP_CUT_MIN_ANSWERS}+ answers per prompt, and an 8-day repeat gap.`);
